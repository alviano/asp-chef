...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to ASP Chef.
...
- __Website__ refers to ASP Chef, accessible from [https://asp-chef.alviano.net/](https://asp-chef.alviano.net/)
...
If you want to remove all our cookies from this browser, please click on the next button. 

<Row class="mb-3">
  <Button color="danger" on:click="{() => Utils.remove_all_cookies()}">Remove all cookies</Button>
</Row>
...
- By visiting this page on our website: [https://alviano.net](https://alviano.net)
