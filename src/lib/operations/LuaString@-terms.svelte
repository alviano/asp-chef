<script context="module">
    ...
    export const default_extra_options = {
        encode_predicate: Option('__base64__', "Predicate to wrap the generated strings in (Base64)", "predicate_name"),
        prefix: Option('string_', "Prefix for the string labels", "string"),
    };
