<script context="module">
    ...
    const operation = "Meta Supported Models";
...
<Operation {id} {operation} {options} {index} {default_extra_options} {add_to_recipe} {keybinding}>
    <div slot="description">
        ...
        <p>
            The meta encoding can be used to compute supported models of a reified program (see the <strong>Reify Program</strong> operation).
        </p>
        <p>
    ...
    <InputGroup>
        ...
        <Input type="text"
               ...
               on:input={edit}
               data-testid="MetaSupportedModels-encode-predicate"
        />
    </InputGroup>
</Operation>
