<script>
    ...
    async function processInput() {
        ...
        analysisData = parseResults(debug_atoms);
    }
...
<div class="p-2 output" data-testid="analisis-output">
    ...
    {:else}
        ...
        >
            ...
            {:else}
                {analysisData.issues.items.length} design issue{analysisData.issues.items.length !==
                1
                    ? 's'
                    : ''} found
            {/if}
