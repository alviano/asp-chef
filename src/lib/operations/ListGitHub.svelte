<script context="module">
    ...
    export const default_extra_options = {
        predicate: Option('__base64__', "Predicate to wrap each fetched GitHub file path in", "predicate_name"),
        url: Option('', "URL of the GitHub repository or directory to list files from", "string"),
